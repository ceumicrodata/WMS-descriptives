...
# this part needs some redo or making the variable scoping first.
...
@replace position = ustrlower(position) # here i have to replace the lowering function
@generate pos = ""
# Okay I think this forloop can be avoided....
for pos in [production, ceo] 
    for word in pos 
